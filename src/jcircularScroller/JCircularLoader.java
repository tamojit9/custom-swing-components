 ...
 * @author tamojit
 */
public class JCircularLoader extends JComponent implements Serializable {
    ...
    void drawLoadingArc(Graphics2D g2d, int radius, int cx, int cy) {
        ...
        g2d.fill(LoadingArc);
        radius = r;
        LoadingArc = getArcShape(cx - radius, cy - radius, radius << 1, radius << 1, progress, 360-progress, 30);
        g2d.fill(LoadingArc);
    }
    ...
    public static void main(String[] argv) throws InterruptedException {
        ...
        final JCircularLoader jcs = new JCircularLoader();
        jcs.setSize(300, 300);
